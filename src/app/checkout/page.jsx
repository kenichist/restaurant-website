      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="p-6">
            ...
            {cartItems.length === 0 ? (
              ...
              <div className="space-y-4 mb-8">
                {cartItems.map((item) => (
                  <div
                    key={item._id}
                    className={`flex items-center justify-between border-b border-amber-100 pb-4 transition-all duration-500 delay-${item._id * 100} ${
            ...
            <div
              className={`flex justify-between items-center pt-4 border-t border-amber-200 transition-opacity duration-500 delay-1000 ${
          ...
          <div
            className={`bg-amber-600 p-6 transition-all duration-500 delay-1200 ${
              showAnimation ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'
            }`}
          >
        ...
        <div
          className={`mt-8 bg-white p-6 rounded-lg shadow-md transition-all duration-500 delay-1500 ${
            showAnimation ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'
          }`}
        >
